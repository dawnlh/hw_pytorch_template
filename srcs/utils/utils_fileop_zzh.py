...
def list_subdir_list(data_dir, ext=None):
    """
    Get file traversing paths for given directory or directory list
    ...
    if isinstance(data_dir, str):
        # single dataset
        data_paths, file_num, skip_num = list_subdir(data_dir, ext)
