...
def main():
    ...
    if vid_format == 'gif':
        ...
        vid_size = ((dst_size[1]+margin[1]*2)*n_row,
                    (dst_size[0]+margin[0]*2)*len(img_dirs)//n_row)
        if vid_format == 'avi':
